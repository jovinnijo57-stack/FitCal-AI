...
export const DEFAULT_RECIPES: Recipe[] = [
  ...
  },
  {
    ...
    ingredients: [
      ...
      {
        id: "i-mustard-seeds---curry-leaves",
  ...
  },
  {
    ...
    ingredients: [
      {
        id: "i-whole-black-lentils--urad-dal-",
  ...
  },
  {
    ...
    ingredients: [
      ...
      { id: "i-sliced-bread", name: "Sliced bread", qty: 2, unit: "pcs" },
      {
        id: "i-chopped-onion---green-chili",
        name: "Chopped onion & green chili",
        qty: 30,
        unit: "g",
      },
      { id: "i-butter", name: "Butter", qty: 15, unit: "g" },
