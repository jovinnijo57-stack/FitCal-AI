...
export const FOODS: Food[] = [
  ...
  {
    id: "h3",
    name: "Grilled Salmon & Asparagus Bowl",
    brand: "Recipe",
    serving: "1 bowl",
    kcal: 360,
    protein: 38,
  ...
  {
    id: "c14",
    name: "Ice Cream Sundae with Caramel",
    serving: "1 bowl",
    kcal: 550,
    protein: 9,
    carbs: 72,
...
export function getCalorieHistory(
  ...
  try {
    ...
    const todayStr = new Date().toLocaleDateString("en-US", { weekday: "short" });
    if (
      currentEaten !== undefined &&
      currentBurned !== undefined &&
      (currentEaten > 0 || currentBurned > 0)
    ) {
      if (history.length === 0) {
